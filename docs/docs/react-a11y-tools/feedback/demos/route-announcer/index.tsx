					...
					<article className={styles.card}>
						<div className={styles["card__container"]}>
							...
							<div className={styles["card__content"]}>
								...
								<p className={styles["card__summary"]}>
									As much as I love an over-the-top, romantic Valentine’s date,
					...
					<article className={styles.card}>
						<div className={styles["card__container"]}>
							...
							<div className={styles["card__content"]}>
								...
								<p className={styles["card__summary"]}>
									HAAAAPPY 2021! It’s the first Monday of the year and I have
									never been so ready for
								</p>
								<div className={styles["card__metadata"]}>
									<p className={styles["card__author"]}>By Segun Adebayo</p>
					...
					<div className={styles.metadata}>
						...
						<div>
							<p className={styles.intro}>
								...
								accusamus voluptate! Accusantium aperiam totam voluptatum at fugiat
								doloribus odit dolore fuga.
							</p>
							<p className={styles.intro}>
								<NavLink
							...
							<div className={styles.rating}>
								<div className={styles["rating__wrapper"]}>
									<p className={styles["visually-hidden"]}>
										...
										<span className={styles["rating__value"]}>4.5</span> out of
										5
									</p>
