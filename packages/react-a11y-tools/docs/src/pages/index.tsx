		...
		<div className={styles.page}>
			<header className={styles.header}>
				<div className={styles.header__container}>
					...
					<h1 className={styles.header__title}>
						{HEADING_TITLE}
						<span className={styles.header__title__version} title={VERSION_TITLE}>
							<span className="sr-only">Currently version: </span>
							{CURRENT_VERSION}
						</span>
					</h1>
				</div>
			...
			<main className={styles["main-content"]}>
				...
				<p className={styles.page__subheading}>
					A small React component library that eases the process of creating <wbr />
				...
				<nav className={styles.page__nav}>
					...
					<p className="sr-only" id="on-a-new-tab">
						This link opens on a new tab
					</p>
					<a
